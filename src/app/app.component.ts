import { Component,HostListener, OnInit, Inject, Renderer2, ElementRef, ViewChild } from '@angular/core';
...
export class AppComponent implements OnInit {
    ...
    constructor(@Inject(DOCUMENT) private document: Document, private renderer : Renderer2, private router: Router, private element : ElementRef, public location: Location) {}
